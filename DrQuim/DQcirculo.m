...
-(void)endTrackingWithTouch:(UITouch *)touch withEvent:(UIEvent *)event
{
    ...
    if(touch.tapCount > 1){
        [self.mix setReceita:self.telaReceitas.receitaEscolhida];
...
-(void)mostrarInfoComposto{
    ...
    NSArray *arrayReceitas = [[NSArray alloc]initWithObjects:@"Líquido Amarelo",nil];
    self.telaReceitas = [[DQTelaInfoReceitas alloc]initComReceitas:arrayReceitas frame:self.superview.bounds];
    
    
    [self.superview addSubview:self.telaReceitas];
